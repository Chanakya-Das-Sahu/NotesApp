...
const Write = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-[#7761a7] to-[#19b698] rounded-2xl flex flex-col justify-center items-center">
            ...
            />
            <textarea
                className="border-4 border-[#7761a7] mb-[40px] h-[500px] w-[500px] rounded-2xl p-2.5 resize-none text-lg outline-none placeholder-gray-400 bg-transparent max-w-full"
                id="write-content"
                name="content"
